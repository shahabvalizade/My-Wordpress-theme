...
function shahabtheme_widgets_init() {
    ...
    register_sidebar(
        array(
            ...
            'id'            => 'footer-1',
            'description'   => esc_html__( 'Add footer widgets here.', 'shahabtheme' ),
            'before_widget' => '<section id="%1$s" class="widget %2$s">',
            'after_widget'  => '</section>',
            'before_title'  => '<h2 class="widget-title">',
            'after_title'   => '</h2>',
    ...
    register_sidebar(
        array(
            'name'          => esc_html__( 'No-Content', 'shahabtheme' ),
            'id'            => 'no-content',
            'description'   => esc_html__( 'Add no-content widgets here.', 'shahabtheme' ),
            'before_widget' => '<section id="%1$s" class="widget %2$s">',
            'after_widget'  => '</section>',
            'before_title'  => '<h2 class="widget-title">',
            'after_title'   => '</h2>',
    ...
    register_sidebar(
        array(
            'name'          => esc_html__( 'Page', 'shahabtheme' ),
            'id'            => 'page-1',
            'description'   => esc_html__( 'Add Page widgets here.', 'shahabtheme' ),
            'before_widget' => '<section id="%1$s" class="widget %2$s">',
            'after_widget'  => '</section>',
            'before_title'  => '<h2 class="widget-title">',
            'after_title'   => '</h2>',
